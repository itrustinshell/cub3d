...
void initialize_player(t_c3d *c3d)
{
	...
	c3d->player.ray.first_side_point.x = 0;
	c3d->player.ray.first_side_point.y = 0;
	...
	c3d->player.ray.range_x_to_test = 0;
	c3d->player.ray.range_y_to_test = 0;

	c3d->player.ray.sy_check = 0;
	c3d->player.ray.end_point_to_check.x = 0;
	c3d->player.ray.end_point_to_check.y = 0;
}
