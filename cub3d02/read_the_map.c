...
/* ora ho quanti byte ho letto e un buffer pieno di questi elementi.
   ...
   questo bufferlo posso coipare altrove cosi che non lo perdo.. a tal proposito mi sono fatto un char *content_file. che man mano verra' popolato dei nuovi buffer letti.


 */
/*rialloco content_file..aumentando la sua dimensione della lettura fatta...cosi poi posso ineserire appunto la lettura fatta + un null terminaitor..
 ma attenzione io non devo aumentare degli ultimi bytes_letti...io di volta in volta devo allocare dell dimensione totale fin qui letta...quinid dovò avere una variabile che mi tiene il conto tale..*/
