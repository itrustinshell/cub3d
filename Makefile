...
SRC = 	c3d.c \
		...
		calculations/dda.c calculations/dda_utils.c calculations/dda_deltax_deltay_distx_disty.c calculations/dda_increment.c calculations/dda_increment_measurement.c calculations/dda_increment_utils.c \
